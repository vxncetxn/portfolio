          ...
          <>
            ...
            {data.songUrl ? (
              ...
              >
                ...
                <span className="ml-8 inline-flex items-end h-16 space-x-2">
                  <span className="w-4 h-8 bg-neutral-02 origin-bottom animate-eq-bar-one"></span>
                  <span className="w-4 h-16 bg-neutral-02 origin-bottom animate-eq-bar-two"></span>
                  <span className="w-4 h-12 bg-neutral-02 origin-bottom animate-eq-bar-three"></span>
                </span>
              </Anchor>
            ) : (
